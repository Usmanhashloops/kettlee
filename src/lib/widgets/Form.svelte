<script>
  ...
  function validatePhoneNumber() {
    ...
    function formSubmission(firstName, lastName, email, phone, message) {

    let data = {
        to: "orders.knc@gmail.com, tb1995@gmail.com",
        subject: "A form was submitted on the Kettlee website",
...
<div class="form-wrapper">
  ...
  <h4 class="form-title">{formMessage}</h4>
    ...
    <input type="text" class="form-control {errorsValid.firstNameValid ? '' : 'invalid'}" bind:value="{fields.firstName}" on:keyup="{validateFirstName}" placeholder="First name" required name="$firstname">
		</div>

		<div class="form-group">
    <input type="text" class="form-control {errorsValid.lastNameValid ? '' : 'invalid'}" bind:value="{fields.lastName}" on:keyup="{validateLastName}"  placeholder="Last name" required name="$lastname">
    </div> 
